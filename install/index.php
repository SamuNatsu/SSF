...
<head>
	...
	<link rel="stylesheet" href="<?php $Router->root('/../shared/modern-normalize.min.css', true); ?>"/>
	<link rel="stylesheet" href="<?php $Router->root('/../shared/flex.css', true); ?>"/>
	<link rel="stylesheet" href="<?php $Router->root('/style.css', true); ?>"/>
	<script src="<?php $Router->root('/../shared/jquery.min.js', true); ?>"></script>
	<script src="<?php $Router->root('/script.js', true); ?>" defer></script>
</head>
<body>
